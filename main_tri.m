...
elementos_nome_ficheiro = "Input Data\projetoMComp_elementos_T3.txt";
nos_nome_ficheiro = "Input Data\projetoMComp_nos_T3.txt";
...
extrair_resultados_TRI("Output Data\resultados_tri3.txt", x, y, u, tri, vx, vy,v, vmax, local_vmax, vmin, local_vmin, p, pmax, local_pmax, pmin, local_pmin)